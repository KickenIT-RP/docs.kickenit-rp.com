...
Whitelisted Gangs are supposed to be held to a higher standard and should always focus on the Roleplay before the Gun play. Always attempt to roleplay out situations such as hostage takings, before shooting the other side. Such as meetings, trades, etc.
...
Currently the following gangs are Whitelisted:
- **Organization**
    - The Cartel 
    - Khaos
- **Gang**
